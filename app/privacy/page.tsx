...
const summaryCards = [
  {
    title: "무엇을 받나요?",
    body: "역할, 회사 규모, 업종, AI 사용 상황과 설문 답변을 받습니다. 선택 신청을 할 때만 이메일과 회사명을 받을 수 있습니다.",
  },
  {
    title: "왜 받나요?",
    body: "자가점검 결과를 보여드리고, 어떤 기능이 필요한지 알아보기 위해 사용합니다.",
  },
  {
    title: "얼마나 보관하나요?",
    body: "설문 답변은 제출 후 6개월 동안 보관한 뒤 삭제합니다. 베타·인터뷰·상담 연락처는 각 안내에 적힌 기간만 보관합니다.",
  },
  {
    title: "누가 처리하나요?",
  ...
  },
  {
    ...
    body: "네. 열람, 수정, 삭제, 동의 철회를 요청할 수 있습니다.",
  },
] as const;
    ...
    <main className={styles.page}>
      <section className={styles.surveyPanel}>
        ...
        <p className={styles.lead}>
          ...
          <br />
          이메일은 베타 참여, 인터뷰, 상담을 신청할 때만 받습니다.
          <br />
